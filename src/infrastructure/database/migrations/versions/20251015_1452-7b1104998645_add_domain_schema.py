...
down_revision: str | None = "b7d360b4abf0"
...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f("entity_aliases_canonical_entity_id_fkey"), "entity_aliases", schema="app", type_="foreignkey")
    ...
    op.drop_constraint(op.f("memory_conflicts_detected_at_event_id_fkey"), "memory_conflicts", schema="app", type_="foreignkey")
    ...
    op.drop_constraint(op.f("memory_summaries_supersedes_summary_id_fkey"), "memory_summaries", schema="app", type_="foreignkey")
    ...
    op.drop_constraint(op.f("semantic_memories_extracted_from_event_id_fkey"), "semantic_memories", schema="app", type_="foreignkey")
    op.drop_constraint(op.f("semantic_memories_subject_entity_id_fkey"), "semantic_memories", schema="app", type_="foreignkey")
    op.drop_constraint(op.f("semantic_memories_superseded_by_memory_id_fkey"), "semantic_memories", schema="app", type_="foreignkey")
